...
public class RexseeSMS {
    ...
    public static final String CONTENT_URI_SMS = "content://sms"; // ¶ÌÐÅ
    public static final String CONTENT_URI_SMS_INBOX = "content://sms/inbox";// ÊÕ¼þÏä
    public static final String CONTENT_URI_SMS_SENT = "content://sms/sent"; // ·¢ËÍ
